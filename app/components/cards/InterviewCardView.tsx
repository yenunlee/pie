...
export interface InterviewCardViewProps {
...
export default function InterviewCardView({
  messages,
  pageIndex,
  totalPages,
  photoUrl,
        ...
        {messages.map((msg, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                style={{
                  ...
                  backgroundColor: isInterviewer
                    ? effectiveDesign.interviewerBubbleColor
                    : effectiveDesign.intervieweeBubbleColor,
              ...
              >
                {plainExportText(msg.content ?? '').trim()}
              </div>
            </div>
          );
        })}
