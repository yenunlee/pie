...
export default function Home() {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-white" style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <Button
                ...
                className="h-9 w-9 rounded-lg border-gray-200 text-gray-500"
                title="Parser format reference"
                aria-label="Parser format reference"
              >
              ...
              <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                  <h2 className="text-2xl font-semibold tracking-tight text-gray-950 sm:text-3xl">
                    원고를 업로드하거나 붙여넣으면 카드뉴스 구조로 정리합니다.
                  </h2>
            ...
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_17rem]">
              ...
              <aside className="space-y-4">
                ...
                <div className="rounded-3xl border border-blue-100 bg-blue-50/70 px-4 py-4">
                  <p className="text-[11px] font-semibold uppercase tracking-widest text-blue-500">Tip</p>
                  <p className="mt-2 text-xs leading-5 text-blue-900/70">
                    Word에서 복사한 뒤 일반 붙여넣기보다 Cmd/Ctrl+V로 붙여넣으면 색상 기반 하이라이트를 더 잘 보존합니다.
                  </p>
                </div>
              </aside>
            </div>
